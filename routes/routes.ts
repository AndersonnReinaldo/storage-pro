...
import { FileProcessor, resizeImage } from "../core/FileProcessor.js";
...
router.post("/save", FileProcessor,resizeImage, async (req, res) => save(req, res));
router.put("/copyDirectory", async (req, res) => copyDirectory(req, res));
router.put("/update", FileProcessor,resizeImage, async (req, res) => update(req, res));
